...
from params import DATA_PATH, CLASSES_NFN_NOSIDE
...
class Config:
    ...
    # Model  # maxvit_tiny_tf_512 coat_lite_medium_384 maxvit_small_tf_384
...
if __name__ == "__main__":
    ...
    df = prepare_data_nfn(DATA_PATH, explode=False, left_right=True)
    ...
    if len(config.selected_folds) == 4:
        ...
        # log_folder = "../logs/2024-08-05/27/"

        df = prepare_data_nfn(DATA_PATH, explode=False, left_right=False)
